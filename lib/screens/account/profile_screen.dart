              ...
              children: [
                    ...
                    Column(
                      children: [
                        customText(
                            ...
                            size: 14),
                        SizedBox(height: 5,),
                        customText("omarElemay@gggr.com",fontWeight: FontWeight.w100,
                ...
                SizedBox(height: 20,),
                 ...
                 ListTile(
                  ...
                  leading: Icon(Icons.person_outline,color: HexColor("#BA6400"),),
                  title: Row(
                    children: [
                      customText(
                          ...
                          ,fontWeight: FontWeight.bold),
                      Spacer(),
                      Expanded(child: customText("omarElemawy",color: HexColor("#9098B1"))),
                    ],
                  ),
                ...
                ListTile(
                  ...
                  contentPadding: EdgeInsets.symmetric(horizontal: 0,vertical: 5),
                  leading: Icon(Icons.email_outlined,color: HexColor("#BA6400"),),
                  title: Row(
                    children: [
                      Expanded(
                        child: customText(
                      ...
                      Spacer(),
                      Expanded(child: customText("omar@jj.fiji",color: HexColor("#9098B1"))),
                    ],
                  ),
                  trailing: Icon(Icons.arrow_forward_ios_sharp,color: HexColor("#9098B1"),size: 12,),
                ),
                ...
                ListTile(
                  ...
                  contentPadding: EdgeInsets.symmetric(horizontal: 0,vertical: 5),
                  leading: Icon(Icons.lock_outline_rounded,color: HexColor("#BA6400"),),
                  title: Row(
                    children: [
                      customText(
